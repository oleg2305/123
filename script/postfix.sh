...
echo "This script was made for Debian 7, but was adapted for Debian 9."
...
apt-get install -y wget postfix apache2 dovecot-core dovecot-imapd postgresql postfix-pgsql dovecot-lmtpd dovecot-pgsql php7.0-imap php7.0-pgsql php7.0-mcrypt php7.0-intl php7.0-mbstring php7.0-xml libapache2-mod-php php-mbstring php-gd php-zip
error_check
...
tar xvf postfixadmin.tar.gz -C /var/www/html
error_check
...
tar xvf roundcubemail-1.3.0-complete.tar.gz -C /var/www/html
error_check

rm -rf roundcubemail-1.3.0-complete.tar.gz
